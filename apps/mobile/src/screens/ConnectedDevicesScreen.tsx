...
function distanceKm(metres: number | undefined) { return metres === undefined ? '—' : `${(metres / 1000).toLocaleString('ru-RU', {maximumFractionDigits: 2})} км`; }
